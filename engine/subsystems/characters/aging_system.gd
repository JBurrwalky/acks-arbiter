...
func _get_ability_floor(character: CharacterData, ability: String) -> int:
	...
	const CLASS_PRIME_REQS: Dictionary = {
		...
		"warlock":         ["INT", "CHA"],
		"witch":           ["INT", "WIS"],
		"lightblessed_wonderworker": ["INT", "WIS"],
		"darkblood_ruinguard":       ["STR", "INT"],
		"dwarven_vaultguard":  ["STR"],
		"dwarven_craftpriest": ["WIS"],
		"dwarven_delver":    ["STR", "INT"],
		"dwarven_fury":      ["STR", "CON"],
		"elven_spellsword":    ["STR", "INT"],
		"elven_nightblade":    ["DEX", "INT"],
