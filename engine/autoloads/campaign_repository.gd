...
const _SCOPE_DIRECT_CAMPAIGN := [
	...
	"setting_poi_seeds", "setting_polities", "setting_regions", "setting_replay_frames",
	"setting_replay_palette", "setting_river_edges", "setting_ruin_seeds", "setting_settlements",
