...
def generate_wealth_sweep_md(templates, cost):
    ...
    lines = [
        ...
        "step 8. Deviations over 40% are flagged for review: they are possible "
        "misreads of the source phrasing OR catalog-granularity artifacts (e.g. "
        "the single 25gp holy symbol, 6gp/week iron rations, 6 weeks of dwarven "
        "jerky), NOT engine bugs.",
        "",
