...
**Status (2026-05-29):** foundation + DG-V1 integration + first-visit materialization + per-cell interaction landed.
...
- Remaining: retirement of `claim_room_hoards` (Commit 5). Pick Lock + Search container action wiring is a follow-up beyond the 5-commit arc — the handler surfaces locked / hidden state cleanly so the UI can prompt without changes here.
