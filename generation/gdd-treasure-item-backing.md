...
**Status (2026-05-29):** foundation + DG-V1 integration landed.
...
- Remaining: first-visit materialization (cell-spawn `location_caches`), per-cell interaction wiring (lock/search/loot), retirement of `claim_room_hoards`.
