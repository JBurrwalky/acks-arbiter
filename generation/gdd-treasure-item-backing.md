...
- **Vorpal Sword = 160,000 gp** (Jedidiah 2026-05-29): Sword +3 base (35,000) + a higher-valued vorpal effect = 160,000 total. Supersedes an earlier 60,000 gp (1st-level-vorpal) derivation. `creation_time_days` is provisionally **190** (it reflected the superseded derivation) — pending a corrected time to match the revised price.
...
- **Vorpal Sword creation time (open):** `value_gp` was corrected to 160,000 (2026-05-29) but `creation_time_days` is still the provisional 190 from the superseded 60,000 derivation. Confirm the intended creation time for the revised price.
