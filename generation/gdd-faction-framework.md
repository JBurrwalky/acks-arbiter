...
- **Politics reaches the dungeon:** if the parent's realm enters war/rebellion, linked detachments get one allegiance-engine pass — the gnoll band may march out to join the horde (dungeon empties: real strategic texture), fortify, or be recalled. Fires at most once per conflict per dungeon (cap, §11.3).
