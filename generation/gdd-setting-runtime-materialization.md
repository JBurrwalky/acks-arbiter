...
- **Phase M1 — Polities + rulers (steps 2–3).** realms + domains (in-area located, rest abstracted) + the §7.3 ruler set incl. `BeastmanRulerMaterializer` + the `ClassedNpcBuilder` adapter + clanhold tribal-warrior pools.
